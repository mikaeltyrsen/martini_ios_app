...
struct FrameBoard: Codable, Identifiable, Hashable {
    ...
    func updatingMetadata(_ metadata: JSONValue?) -> FrameBoard {
        FrameBoard(
            ...
            label: label,
            order: order,
            isPinned: SafeBool(wrappedValue: isPinned),
            fileUrl: fileUrl,
            fileThumbUrl: fileThumbUrl,
            fileName: fileName,
            fileType: fileType,
            fileSize: SafeOptionalInt(wrappedValue: fileSize),
            fileCrop: fileCrop,
            metadata: metadata,
            createdBy: createdBy,
            createdAt: createdAt,
...
struct Frame: Codable, Identifiable {
    ...
    func updatingFrameOrder(_ order: String?) -> Frame {
        copyFrame(frameOrder: order)
    }
    ...
    private func copyFrame(
        ...
        Frame(
            ...
            createdAt: createdAt,
            lastUpdated: lastUpdated,
            frameOrder: frameOrder ?? self.frameOrder,
